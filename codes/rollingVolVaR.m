function [VaR, ETL] = rollingVolVaR(returns, windowSize, conf, inv0, forecastVec, trainingSize, model, P, Q, nu)
...
for i = 1:nEstimates
   ...
   [VaR(i)]= historicalVaR(weightedReturns, conf, inv0);
   [ETL(i)] = historicalETL(weightedReturns, conf, inv0 );
